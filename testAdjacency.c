...
int main(void) {
    printf("\n#############################################################################\n");
    {
        ...
        bfwalk(threeW, causal, 0.5, result, NULL);
    ...
    printf("\n#############################################################################\n");
    {
        ...
        bfwalk(diam4, causal, 0.5, result, NULL);
        printf("Diam4 scores\n");
        printScores(result);
        // compare with expected final scores
    ...
    printf("\n#############################################################################\n");
    {
        ...
        bfwalk(diam6, causal, 0.5, result, NULL);
        printf("diam6 scores\n");
    ...
    printf("\n#############################################################################\n");
    {
        ...
        bfwalk(asym, causal, 0.5, result, "cachefile_BFWalk_asym");
        printf("ASYM scores\n");
        printScores(result);
